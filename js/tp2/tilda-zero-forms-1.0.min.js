...
function t_zeroForms__createForm(t, e, r, o) {
    ...
    var n = t_zeroForms__createFormObj(t, o),
        ...
        _;
    if (s.classList.add("t-form"), s.classList.add("t-form_inputs-total_" + a.length), n.inputsstyle && s.classList.add("t-form_bbonly"), "h" === n.inputpos && s.classList.add("tn-form_horiz"), i && (s.id = "form" + t, s.name = "form" + t, s.action = "https://forms.tildacdn.com/procces/", s.method = "POST", s.classList.add("js-form-proccess"), s.setAttribute("role", "form"), s.setAttribute("data-formactiontype", "2"), s.setAttribute("data-inputbox", ".t-input-group"), s.setAttribute("data-success-callback", "t396_onSuccess"), s.setAttribute("data-success-popup", "y"), s.setAttribute("data-error-popup", "y"), n.formmsgurl && s.setAttribute("data-success-url", n.formmsgurl)), (n.receivers ? n.receivers.split(",") : []).forEach((function(t) {
    ...
    if (s.insertAdjacentElement("beforeend", t_zeroForms__createErrorBox(n, "bottom")), s.insertAdjacentElement("beforeend", t_zeroForms__createCommentField()), t_zeroForms__createInputPlaceholderStyles(l, n, t, o), "h" === n.inputpos || "zero" === e) {
    ...
    if (n.fieldfontfamily) {
        var z = t_zeroForms__createSelector(t, l, ""),
        ...
        t_zeroForms__setScriptOrStyle(h, "", (w = w.reduce((function(t, e, r) {
            return t += z + ".t-input-block " + e, r !== w.length - 1 && (t += ", "), t
...
function t_zeroForms__generateInputsBlock(t, e, r, o, n) {
    ...
    return s.classList.add("t-form__inputsbox"), a.forEach((function(r) {
        var a = t_zeroForms__parseIntoElement(t, e, r, o, n, i);
        a && s.insertAdjacentElement("beforeend", a)
    })), s.insertAdjacentElement("beforeend", t_zeroForms__createErrorBox(o, "middle")), s.insertAdjacentElement("beforeend", t_zeroForms__createFormButton(t, e, i, o)), s
}
...
function t_zeroForms__parseIntoElement(t, e, r, o, n, i) {
    ...
    switch (p.classList.add("t-input-block"), r.li_type) {
        case "em":
            ...
            break;
        case "ph":
            f = t_zeroForms__createPhoneInput(t, r, d, m), "a" === r.li_masktype && (t_zeroForms__setScriptOrStyle("t-zero-phonemask", "tilda-phone-mask-1.1.min.js", "", "script", !1), t_zeroForms__onRender(e, !0, (function() {
        ...
        case "rd":
            ...
            var h = t ? "#rec" + t + " " : "";
            t_zeroForms__setScriptOrStyle("t-zero-form-fieldset-" + t, "", h += "fieldset {padding: 0; margin: 0; border: none;}", "style", e), "checkbox" === y && t_zeroForms__onRender(e, !1, (function() {
            ...
            break;
        case "ri":
            f = t_zeroForms__createRadioImage(r, o, m), t_zeroForms__setIndicatorStyles(t, i, o.inputelscolor, "img-select", f), t_zeroForms__setScriptOrStyle("t-zero-img-select-styles", "tilda-img-select-1.0.min.css", "", "link", !1), t_zeroForms__setScriptOrStyle("t-zero-img-select-script", "tilda-img-select-1.0.min.js", "", "script", !1), t_zeroForms__onRender(e, !1, (function() {
        ...
        case "cb":
            ...
            break;
        case "uw":
            f = t_zeroForms__createUploadField(r, m, "uw"), "published" === window.tildamode && t_zeroForms__onRender(e, !0, (function() {
        ...
        case "uc":
            ...
            t_zeroForms__setScriptOrStyle("t-zero-uploadcare-" + i, "", z += 'UPLOADCARE_TABS = "all";', "script", !1);
            break;
        case "da":
        ...
        case "ur":
            ...
            break;
        case "tx":
            (f = document.createElement("div")).classList.add("t-text"), f.setAttribute("field", "li_text__" + r.lid), f.style.fontWeight = u.fontWeight, f.style.fontSize = u.fontSize + "px", f.style.fontFamily = n.fontFamily, f.style.color = n.color, f.innerHTML = r.li_text || "";
            break;
        case "ws":
    ...
    if (k.classList.add("t-input-error"), p.insertAdjacentElement("beforeend", k), s.insertAdjacentElement("beforeend", p), "h" !== o.inputpos) {
        var j = r.li_type;
        "em" !== j && "ph" !== j && "nm" !== j && "in" !== j && "ta" !== j && "sb" !== j && "cb" !== j && "uw" !== j && "da" !== j && "tm" !== j && "qn" !== j && "rg" !== j && "ur" !== j && "tx" !== j || t_zeroForms__setFieldsRowClasses(m, s), "rd" === r.li_type && t_zeroForms__setRadioRowClasses(m, p)
    }
    return s
}
...
function t_zeroForms__generateTitle(t, e, r, o) {
    ...
    "LABEL" === a.tagName && (a.style.display = "block"), "LABEL" === a.tagName && a.setAttribute("for", t.li_type + "-" + t.lid), a.classList.add("t-input-title"), a.setAttribute("data-redactor-toolbar", "no"), a.setAttribute("field", "nullli_title__" + t.lid), t_zeroForms__setTitleStyles(a, e, o), a.textContent = t.li_title, r.insertAdjacentElement("beforeend", a)
}
...
function t_zeroForms__createSelect(t, e, r, o) {
    ...
    return n.forEach((function(t, r) {
        ...
        o.value = t, o.textContent = t, l && (o.style.color = e.color), i && i === r + 1 && (o.selected = !0), s.insertAdjacentElement("beforeend", o)
...
function t_zeroForms__createRadio(t, e, r, o, n, i, a) {
    ...
    return s.forEach((function(s, l) {
        ...
        m.type = n, m.value = s, m.classList.add("t-" + n), _ || m.classList.add("js-tilda-rule"), _ || (m.name = r.name);
        ...
        if (F.textContent = s, u.insertAdjacentElement("beforeend", F), s === t.li_ownvariant) {
...
function t_zeroForms__createRadioImage(t, e, r) {
    ...
    if (n) {
        ...
        return i.forEach((function(n, i) {
            ...
            c.type = _, c.value = n.alt || n.img, c.classList.add("t-img-select"), o || (c.name = t.li_nm), o || c.classList.add("js-tilda-rule"), a && a === i + 1 && (c.checked = !0), r.require && c.setAttribute("data-tilda-req", "1"), s.insertAdjacentElement("beforeend", c);
            var u = t_zeroForms__createIndicator("img-select", !1, {
                ratio: d,
                img: n.img
            });
            if (u.classList.add("t-bgimg"), u.classList.add("t-img-select__indicator"), t.li_img_fill_mode && u.classList.add("t-img-select__indicator_fillmode-" + t.li_img_fill_mode), e.inputtitlecolor && (u.style.borderColor = t_zeroForms__fromHEXtoRGBA(e.inputtitlecolor, .1)), u.classList.add(d), u.setAttribute("data-original", n.img), u.style.backgroundImage = 'url("' + n.img + '")', s.insertAdjacentElement("beforeend", u), n.alt) {
                var m = document.createElement("div");
                m.classList.add("t-img-select__text"), m.classList.add("t-text"), m.classList.add("t-text_xs"), m.textContent = n.alt, e.inputtitlecolor && (m.style.color = e.inputtitlecolor), s.insertAdjacentElement("beforeend", m)
            }
...
function t_zeroForms__createCheckbox(t, e, r, o) {
    ...
    return s.classList.add("t-checkbox__labeltext"), s.innerHTML = t.li_label || "", n.insertAdjacentElement("beforeend", s), n
}
...
function t_zeroForms__createUploadField(t, e, r) {
    ...
    return "uploadcare-3.x.min.js" !== d || window.jQuery || (d = "uploadcare-3.x.full.min.js"), (o || !o && !document.querySelector('script[src*="uploadcare-3.x"]')) && t_zeroForms__setScriptOrStyle(s + "-zero-form", d, "", "script", !1), l
}
...
function t_zeroForms__createQuantityRange(t, e, r, o) {
    var n = t_zeroForms__createWrapper("t-range__wrapper"),
        i = document.createElement("input");
    t_zeroForms__appendMainSettingToField(i, o, "range", "t-range"), r.inputelscolor && i.setAttribute("data-range-color", r.inputelscolor), i.min = t.li_vmin || "0", i.max = t.li_vmax || "10", i.step = t.li_step || "1", i.value = t.li_value, i.style.width = "100%", t.li_title || t.li_subtitle ? i.id = t.li_type + "-" + t.lid : i.ariaLabel = "range", n.insertAdjacentElement("beforeend", i);
    ...
    return s.insertAdjacentElement("beforeend", l), s.insertAdjacentElement("beforeend", _), n.insertAdjacentElement("beforeend", s), t_zeroForms__setScriptOrStyle("t-zero-range-script", "tilda-range-1.0.min.js", "", "script", !1), t_zeroForms__setScriptOrStyle("t-zero-range-styles", "tilda-range-1.0.min.css", "", "link", !1), n
}
...
function t_zeroForms__createCalculation(t, e, r, o) {
    ...
    var s = document.createElement("span");
    if (s.classList.add("t-calc"), s.setAttribute("data-calc-expr", t_zeroForms__removeStringQuotes(t.li_expr)), s.textContent = "0", a.insertAdjacentElement("beforeend", s), t_zeroForms__createCalcTextField(t.li_postfix, "postfix", a), t_zeroForms__setScriptOrStyle("t-zero-calc", "tilda-calc-1.0.min.js", "", "script", !1), n.appendChild(a), "y" !== t.li_addtocart) return n;
    if (t.li_prod_title) {
...
function t_zeroForms__createFormButton(t, e, r, o) {
    ...
    return t_zeroForms__setBtnInlineStyles(o, i), n.insertAdjacentElement("beforeend", i), "zero" === window.tildamode || "edit" === window.tildamode ? (window.tn && window.tn.curResolution < 640 && (i.style.whiteSpace = "normal"), t_zeroForms__generateBtnStyles(i, t, r, o, e)) : t_zeroForms__onRender(e, !0, (function() {
...
function t_zeroForms__generateBtnStyles(t, e, r, o, n) {
    ...
    u && (p += u, t.classList.add("tn-form__submit-gradient"), l && (p += c + ".uploadcare--widget__button.uploadcare--widget__button_type_open ", p += "{background-image: " + o.buttonbgcolor + "; background-color: transparent;}"), _ && (p += c + ".t-upwidget-container__button ", p += "{background-image: " + o.buttonbgcolor + "; background-color: transparent;}"));
...
function t_zeroForms__createErrorBox(t, e) {
    ...
    var n = document.createElement("div"),
        i;
    n.classList.add("t-form__errorbox-text"), n.classList.add("t-text_xs"), n.classList.add("t-text"), ["all", "req", "email", "name", "phone", "string"].forEach((function(e) {
    ...
    var a = document.createElement("div");
    return a.classList.add("tn-form__errorbox-close"), a.classList.add("js-errorbox-close"), a.insertAdjacentElement("beforeend", t_zeroForms__createErrorBoxBtn("left")), a.insertAdjacentElement("beforeend", t_zeroForms__createErrorBoxBtn("right")), o.insertAdjacentElement("beforeend", a), document.removeEventListener("click", t_zeroForms__initErrorBoxClose), document.addEventListener("click", t_zeroForms__initErrorBoxClose), t_zeroForms__setScriptOrStyle("t-zero-form-errorbox-styles", "tilda-zero-form-errorbox.min.css", "", "link", !1), r
}
...
function t_zeroForms__animateInputs(t, e, r, o) {
    ...
    if (Array.prototype.slice.call(document.querySelectorAll(l)).forEach((function(t) {
            ...
            if (r) {
                var o = document.createElement("div");
                o.classList.add("t-input__vis-ph"), a && (o.style.top = a + "px"), s && (o.style.fontWeight = s), e.inputfontsize && (o.style.fontSize = e.inputfontsize + "px", o.style.height = parseInt(e.inputfontsize, 10) + 1 + "px"), o.textContent = r, t.insertAdjacentElement("afterend", o), t.removeAttribute("placeholder")
            }
...
function t_zeroForms__setScriptOrStyle(t, e, r, o, n) {
    if (!document.getElementById(t)) {
        ...
        r ? c.textContent = r : ("script" === o ? (c.src = _ + "/js/" + e, c.async = !0, c.charset = "utf-8") : "link" === o && (c.href = _ + "/css/" + e, c.rel = "stylesheet"), c.onerror = function() {
