...
function tcart__init(t, e) {
    ...
    if (r) {
        ...
        if (c && (window.tcart_maxstoredays = c), "y" == r.getAttribute("data-cart-sendevent-onadd") && (window.tcart_sendevent_onadd = "y"), window.tcart_fullscreen = "yes" === r.getAttribute("data-cart-fullscreen"), window.tcart_fullscreen) {
            var s = "https://static.tildacdn." + tcart__getRootZone() + "/css/tilda-cart-fullscreen-1.0.min.css",
                u;
            ...
            if ("matchMedia" in window || "msMatchMedia" in window) {
                ...
                var w = function r(o) {
                    "function" == typeof p.addEventListener ? p.removeEventListener("change", w) : p.removeListener(w), o.matches !== window.tcart_isMobile && (window.tcart_isMobile = o.matches, tcart__init(t, e), tcart__syncProductsObject__LStoObj(), tcart__updateProductsPrice(), tcart__reDrawProducts(), tcart__reDrawTotal(), tcart__initAuthAndDelivery())
                };
        ...
        b && (b.innerHTML = tcart_dict("clickToOrder")), document.querySelector('script[src*="tilda-widget-positions"]') || t_onFuncLoad("t_loadJsFile", (function() {
            t_loadJsFile("https://static.tildacdn." + tcart__getRootZone() + "/js/tilda-widget-positions-1.0.min.js")
        ...
        var E = r.querySelector(".t706__cartwin-prodamount-label"),
            k = r.querySelector(".t706__cartwin-totalamount-label");
        if (r.querySelector(".t-input-group_dl") ? (E && (E.innerHTML = tcart_dict("subtotal") + ": "), k && (k.innerHTML = tcart_dict("grandTotal") + ": ")) : (E && (E.innerHTML = tcart_dict("total") + ": "), k && (k.innerHTML = tcart_dict("total") + ": ")), window.tcart_fullscreen) {
            var E;
            (E = document.querySelector(".t706__sidebar-prodamount-label")) && (E.innerHTML = tcart_dict("total") + ": ");
            var L = r.querySelector(".t706__cartpage-prodamount .t706__cartpage-info-label");
            L && (L.innerHTML = tcart_dict("subtotal") + ": ");
        ...
        var O = r.querySelector(".t-input-group_pm");
        O && (O.querySelector(".t-input-title").innerHTML = tcart_dict("paymentMethod"));
        var C = r.querySelector(".t-form__submit"),
            x = r.querySelector(".t706__minimal");
        if (C && x && (C.addEventListener("mouseenter", (function() {
            ...
            if (D) {
                var R = D.getAttribute("data-tilda-mode"),
                    F;
                "edit" !== R && "preview" !== R && (window.history.replaceState("", document.title, window.location.href.split("#")[0]), tcart__openCart())
            }
        }
...
function tcart__initAuthAndDelivery(t) {
    return void 0 === t && (t = !1), !t && window.tcart_isAuthInited ? Promise.resolve() : (window.tcart_isAuthInited = !0, tcart__form__hideErrors(), tcart__blockSubmitButton(), tcart__auth__init().then(_async((function(t) {
        var e, r = t || window.tcartAuthState || {},
            o = r.lkpSettings,
            a = r.mauser,
            n = !(null == a || !a.token),
            i = !(null == (e = window.tildaMembers) || !e.is_init_store),
            c = tcart__findSaveFieldsCheckbox();
        return _invoke((function() {
            if (c || i) return _call(tcart__loadRestoreFieldsFile, (function() {
                var t;
                return tcart__handleSaveFieldsOnCheckout(), _invoke((function() {
                    if (n) return _call(tcart__auth__getLastOrderFields, (function(e) {
                        t = e
                    }))
                }), (function() {
                    return _invoke((function() {
                        if (!t) return _await(window.tcart__restoreFields.getFormFieldsFromLS(), (function(e) {
                            t = e
                        }))
                    }), (function() {
                        t && window.tcart__restoreFields.restoreFields(t), n && tcart__auth__fillUserFields(a)
                    }))
                }))
            }))
        }), (function() {
            var t;
            if (!n && "required" === (null == o ? void 0 : o.auth_required) ? (tcart__form__hideFormFields(), tcart__hideBottomTotalAmount(), tcart__form__disableFormFields(), tcart__form__insertValidateRule("unauthorized_order")) : (tcart__initDelivery(), tcart__form__showFormFields()), c && i) {
                var e = c.closest(".t-input-group");
...
function tcart__handleSaveFieldsOnCheckout() {
    ...
    t && (t.removeEventListener("tildaform:beforesend", tcart__saveFieldsOnCheckout), t.addEventListener("tildaform:beforesend", tcart__saveFieldsOnCheckout))
}
...
function tcart__saveFieldsOnCheckout(t) {
    ...
    if (!(null == (e = window.tildaMembers) || !e.is_init_store)) window.tcart__restoreFields.clearStorage();
        ...
        var o = t.target;
        if (o) {
            var a = tcart__findSaveFieldsCheckbox();
            a && a.checked && tcart__restoreFields.saveFormFieldsToLS(o)
        }
    }
}
...
function tcart_dict(t) {
    ...
    return e.youAdd = {
        ...
        EN: 'To place an order, <a href="#login" class="t706__auth__link">log in</a> or <a href="#register" class="t706__auth__link">sign up</a>',
        ...
        ES: 'Para realizar un pedido, <a href="#login" class="t706__auth__link">inicie sesión</a> o <a href="#register" class="t706__auth__link">regístrese</a>',
        PT: 'Para fazer um pedido, <a href="#login" class="t706__auth__link">faça login</a> ou <a href="#register" class="t706__auth__link">cadastre-se</a>',
        ...
        EN: 'Shopped with us before? <a href="#login" class="t706__auth__link">Log in</a> or <a href="#register" class="t706__auth__link">sign up</a>',
        ...
        DE: 'Schon einmal bei uns eingekauft? <a href="#login" class="t706__auth__link">Melden Sie sich an</a> oder <a href="#register" class="t706__auth__link">registrieren Sie sich</a>',
        ES: '¿Ha comprado con nosotros antes? <a href="#login" class="t706__auth__link">Inicie sesión</a> o <a href="#register" class="t706__auth__link">regístrese</a>',
        PT: 'Já comprou conosco antes? <a href="#login" class="t706__auth__link">Faça login</a> ou <a href="#register" class="t706__auth__link">cadastre-se</a>',
        ...
        EN: 'Shopped with us before? <a href="#login" class="t706__auth__link">Log in</a>',
        ...
        DE: 'Schon einmal bei uns eingekauft? <a href="#login" class="t706__auth__link">Melden Sie sich an</a>',
        ES: '¿Ha comprado con nosotros antes? <a href="#login" class="t706__auth__link">Inicia sesión</a>',
        PT: 'Já comprou conosco antes? <a href="#login" class="t706__auth__link">Faça login</a>',
        ...
        DE: "Sie sind angemeldet als #link",
        ES: "Está conectado como #link",
                ...
                if ("yes" != o.getAttribute("data-dbclk-prevent")) {
                    ...
                    if ("#order:" === i.substring(0, 7)) {
                        ...
                        if (L) {
                            if (L.indexOf(":::") > 0) {
                                var q = L.indexOf(":::");
                                if (L.indexOf("=") > 0 && L.indexOf("=") < L.indexOf(":::")) {
                                    var A = L.substring(q + 3);
                                    if (L = L.substring(0, q), -1 !== A.indexOf(":::"))
                            ...
                            if (L.indexOf("=") > 0) {
                                var O = L.split("=");
                                O[0] && (d = O[0].trim()), O[1] && (c = O[1]), c = tcart__cleanPrice(c)
                            } else d = L;
                    ...
                    var x = o.closest(".js-product");
                    if (x) {
                        if ("" == d) {
                            var D = x.querySelector(".js-product-name");
                            d = D ? D.textContent.trim() : ""
                        }
                        if ("" == c || 0 == c) {
                            var R = x.querySelector(".js-product-price");
                            R && (c = R.classList.contains("js-store-prod-price-range-val") ? R.getAttribute("data-product-price-range-val") : R.textContent), c = tcart__cleanPrice(c)
                        }
                        if ("" == s)
                            if (x.getAttribute("data-product-img")) s = x.getAttribute("data-product-img");
                            else {
                                var F = x.querySelector(".js-product-img");
                                if (F) {
                                    var I = F.getAttribute("data-original") || "";
                                    if (I.length > 0) s = I;
                                    else if ("IMG" == F.tagName) s = F.getAttribute("src");
                                    else if ("DIV" == F.tagName) {
                                        s = "";
                                        var M = getComputedStyle(F)["background-image"];
                                        M && (s = M.replace("url(", "").replace(")", "").replace(/"/gi, ""))
                                    }
                                }
                            } if ("" == l && (l = x.getAttribute("data-product-lid") || ""), "" == _ && (_ = x.getAttribute("data-product-uid") || ""), "" == p) {
                            var K = x.closest(".r").getAttribute("id");
                            p = K ? K.replace("rec", "") : ""
                        }
                        "" == w && (w = x.getAttribute("data-product-inv") || ""), y = x.getAttribute("data-product-unit") || "", f = x.getAttribute("data-product-portion") || "", m = x.getAttribute("data-product-single") || "";
                        var U = [],
                            H = x.querySelectorAll(".js-product-edition-option");
                        Array.prototype.forEach.call(H, (function(t) {
                            ...
                            if (r) {
                                ...
                                if (a = tcart__cleanPrice(a), e && o) {
                                    var n = {};
                                    "" != e && (e = tcart__escapeHtml(e)), "" != o && (o = (o = tcart__escapeHtml(o)).replace(/(?:\r\n|\r|\n)/g, "")), e.length > 1 && ":" == e.slice(-1) && (e = e.slice(0, -1)), n.option = e, n.variant = o, n.price = a, U.push(n)
                                }
                            }
                        }));
                        var N = x.querySelectorAll(".js-product-option");
                        ...
                        var z = x.querySelectorAll(".js-product-multioption");
                        ...
                        })), "" == u && (u = x.querySelector(".js-product-sku") ? x.querySelector(".js-product-sku").textContent.trim() : ""), "" == u && (u = x.querySelector(".js-store-prod-sku") ? x.querySelector(".js-store-prod-sku").textContent.trim() : ""), "" == v && (v = x.getAttribute("data-product-pack-label") || ""), "" == h && (h = x.getAttribute("data-product-pack-m") || ""), "" == g && (g = x.getAttribute("data-product-pack-x") || ""), "" == b && (b = x.getAttribute("data-product-pack-y") || ""), "" == S && (S = x.getAttribute("data-product-pack-z") || ""), "" == E && (E = x.getAttribute("data-product-part-uid") || ""), "" == k && (k = x.getAttribute("data-product-gen-uid") || "")
                    }
                    var B = x ? x.getAttribute("data-product-url") : "",
                        J = x ? x.querySelector('a[href="#order"]:not(.t-btn)') : "",
                        Z = x ? x.querySelector('.js-product-link:not([href="#prodpopup"]):not([href="#order"])') : "";
                    ...
                    if (!B && V ? B = V : !B && p && l && !J ? B = window.location.origin + window.location.pathname + "#!/tproduct/" + p + "-" + l : B || (B = window.location.origin + window.location.pathname + "#rec" + p), "" != d || "" != c && 0 != c) {
                        ...
                        var W = {};
                        if (W.name = d, W.price = c, W.img = s, W.recid = p, W.lid = l, W.pack_label = v, W.pack_m = h, W.pack_x = g, W.pack_y = b, W.pack_z = S, W.part_uids = E.split(","), W.gen_uid = k, W.url = B, U && U.length > 0 && (W.options = U), u && (u = tcart__escapeHtml(u), W.sku = u), _ && (W.uid = _), l && (W.lid = l), w > 0 && (W.inv = parseInt(w, 10)), "" === w || 0 !== parseInt(w, 10)) {
        ...
        function a() {
            ...
            if (!0 === t.is_init_store) return Promise.all([tcart__auth__getLkpSettings(), tcart__auth__getMembersSettings(), tcart__auth__getMauser()]).then((function(e) {
                var r = e[0],
                    ...
                    a = e[2],
                    n;
                if (r && o) return tcart__auth__insertAuthEl(n = null != a && a.token ? tcart__auth__createLoggedInEl(a) : tcart__auth__createAuthEl(r, o)), window.tcartAuthState = {
                    lkpSettings: r,
                    members: t,
                    membersSettings: o,
                    mauser: a
...
function tcart__auth__getLkpSettings() {
    var t, e;
    return tcart__fetchData("https://" + tcart__getServerName() + "/api/orders/getordersmanagemntparams/").then((function(t) {
        return t.ordersmanagement ? t.params : Promise.reject("ordersmanagement does not enabled")
    })).catch((function(t) {
        console.error(t)
    }))
}
...
function tcart__updateProductsPrice(t) {
    ...
    if (window.tcart && window.tcart.updated && window.tcart.products && window.tcart.products.length) {
        ...
        t && !window.tcart.ignoreTimestamp && (window.tcart.ignoreTimestamp = e);
        var o = t && (e === window.tcart.ignoreTimestamp || e - window.tcart.ignoreTimestamp > 60);
        if ((e - r) / 3600 > 3 || o) {
            window.tcart.ignoreTimestamp && e !== window.tcart.ignoreTimestamp && (window.tcart.ignoreTimestamp = e);
            var a = {};
            a.prodamount = window.tcart.prodamount, a.discount = window.tcart.discount, a.products = JSON.stringify(window.tcart.products), a.amount = window.tcart.amount, a.total = window.tcart.total, a.updated = window.tcart.updated, a = JSON.stringify(a), window.tcart_endpoint || (window.tcart_endpoint = "store.tildacdn.com");
            var n = "https://" + window.tcart_endpoint + "/api/getpriceproducts/",
                i = new XMLHttpRequest;
            i.open("POST", n), i.onload = function() {
                if (i.status >= 200 && i.status < 400) {
                    ...
                    try {
                        ...
                        r.good && e.push.apply(e, Object.values(r.good).filter(o)), r.bad && e.push.apply(e, Object.values(r.bad).filter(o))
                    } catch (a) {
                    ...
                    Object.keys(e).forEach((function(t) {
                        var r = e[t],
                            o = r.uid || r.lid;
                        if ("PRICE_CHANGED" === r.error || "PRICE_CHANGED" === r.warning) {
                            var a = "";
                            r.options && r.options.forEach((function(t) {
                        ...
                        "LESS_PRODUCTS" !== r.error && "NOT_FOUND_PRODUCT" !== r.error && "NOT_FOUND_PRODUCT" !== r.warning || window.tcart.products.forEach((function(t, e) {
                            var r = t.uid || t.lid;
...
function tcart__openCart() {
    if (window.tcart_fullscreen) tcart__openCartSidebar();
        ...
        }), 0), tcart__reDrawProducts(), tcart__reDrawTotal(), tcart__initAuthAndDelivery(), document.addEventListener("keyup", tcart__keyUpFunc), tcart__onFuncLoad("t_forms__calculateInputsWidth", (function() {
            ...
            Array.prototype.forEach.call(l.querySelectorAll(".t706__product-deleted__timer__return"), (function(e) {
                var o = function a() {
                    if (l.setAttribute("data-clicked", "yes"), clearInterval(y), tcart_fadeOut(l, 200, (function() {
                        ...
                        var n = window.tcart.products.filter((function(t) {
                            return !tcart__isEmptyObject(t)
                        })).length;
                        0 !== window.tcart.products.length && 0 !== n || tcart__closeCart()
                    ...
                    (!i || i && !i.querySelector(".tcart__preloader")) && tcart__unblockSubmitButton(), e.removeEventListener("click", o)
                };
...
function tcart__openCartFullscreen() {
    ...
    }), 0), tcart__syncProductsObject__LStoObj(), tcart__updateProductsPrice(), tcart__reDrawProducts(), tcart__reDrawTotal(), tcart__initAuthAndDelivery(), document.addEventListener("keyup", tcart__keyUpFunc), 0 === window.tcart.products.length ? tcart__blockSidebarContinueButton() : tcart__unblockSidebarContinueButton(), t_triggerEvent(document, "fullscreenCartOpened"), tcart__onFuncLoad("t_forms__calculateInputsWidth", (function() {
        t_forms__calculateInputsWidth()
    }))
}
...
function tcart__loadRestoreFieldsFile() {
    return new Promise((function(t) {
        t_loadJsFile("https://static.tildacdn." + tcart__getRootZone() + "/js/tilda-cart-restorefields-1.0.min.js", (function() {
...
function tcart__insertDiscountsScript() {
    ...
    if (document.getElementById("cart_discounts_script")) tcart__onFuncLoad("tcart__calcAmountWithDiscounts", (function() {
        ...
        e.id = "cart_discounts_script", e.type = "text/javascript", e.src = "https://static.tildacdn." + tcart__getRootZone() + "/js/" + t + ".min.js", e.onload = function() {
        ...
        var r = document.createElement("link");
        r.id = "cart_discounts_style", r.rel = "stylesheet", r.href = "https://static.tildacdn." + tcart__getRootZone() + "/css/" + t + ".min.css", document.head.appendChild(r)
    }
}
            ...
            if (o.readyState === o.DONE) {
                if (200 === o.status) {
                    ...
                    try {
                        ...
                        return console.log("Error parsing JSON:", '"' + o.responseText + '"'), r(new Error(a))
                    }
